...
public class login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (id != 0) {
            ...
            List listAdmin;
            listAdmin = admin.getUserAdmin(id, m.em);
            System.out.println(listAdmin);
            if (listAdmin.size() != 0) {
                new com.mycompany.bolnicya.gui.admin().setVisible(true);
            }
            Registar reg = new Registar();
            List listRegistar;
            listRegistar = reg.getUserRegistar(id, m.em);
            System.out.println(listRegistar);
            if (listRegistar.size() != 0) {
                new com.mycompany.bolnicya.gui.registar().setVisible(true);
            }
            Doctor doc = new Doctor();
            List listDoctor;
            listDoctor = doc.getUserDoctor(id, m.em);
            System.out.println(listDoctor);
            if (listDoctor.size() != 0) {
                new com.mycompany.bolnicya.gui.doctor().setVisible(true);
